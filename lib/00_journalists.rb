...
print"> "
puts journalists.sort { |w1, w2| w1.casecmp(w2) }

puts "Trie la liste de handle par taille des handle (les plus petits en premiers, les plus grands après)"
print"> "
puts journalists.sort_by(&:length) #ou tableau.sort_by {|tableau| tableau.lenght}
